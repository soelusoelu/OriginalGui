...
private:
    ...
    static unsigned stbDecompress(unsigned char* dst, const unsigned char* src, unsigned length);
    static unsigned stbDecompressLength(const unsigned char* input);
    static const unsigned char* stbDecompressToken(const unsigned char* i);
    static void decode85(unsigned char* dst, const unsigned char* src);
    static unsigned decode85Byte(char c);

    static int stbIn2(const unsigned char* src, int x);
    static int stbIn3(const unsigned char* src, int x);
    static int stbIn4(const unsigned char* src, int x);

    static void stbMatch(const unsigned char* data, unsigned int length);
    static void stbLit(const unsigned char* data, unsigned int length);
